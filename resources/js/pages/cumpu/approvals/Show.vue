...
function submitApprove() {
  ...
  router.patch(
    ...
    { review_note: reviewNote.value || undefined },
    {
      preserveScroll: true,
      onSuccess: () => {
        notify.success(__("Approval granted."));
      },
      onError: () => {
        notify.error(__("Unable to update this approval request."));
      },
      onFinish: () => {
...
function submitReject() {
  ...
  router.patch(
    ...
    { review_note: reviewNote.value || undefined },
    {
      preserveScroll: true,
      onSuccess: () => {
        notify.success(__("Approval rejected."));
      },
      onError: () => {
        notify.error(__("Unable to update this approval request."));
      },
...
function submitCancel() {
  ...
  router.patch(
    ...
    {},
    {
      preserveScroll: true,
      onSuccess: () => {
        notify.success(__("Approval request cancelled."));
      },
      onError: () => {
        notify.error(__("Unable to update this approval request."));
      },
    ...
    <div class="mx-auto flex w-full max-w-5xl flex-col gap-6 p-4 md:p-6">
            ...
            <div class="min-w-0 flex-1 space-y-3">
              ...
              <p class="text-sm text-muted-foreground">
                ...
                <span class="font-medium text-foreground">
                  {{ props.approval.requested_by_name ?? __("Unknown") }}
                </span>
                <span class="mx-1.5 select-none" aria-hidden="true">·</span>
                {{
                  dateFormatter.format(new Date(props.approval.requested_at))
                }}
              </p>
            </div>
      ...
      <div class="grid gap-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,1fr)]">
        ...
        <div class="space-y-5">
          ...
          >
            <div class="border-b border-sidebar-border/70 px-4 py-2.5">
              <p
            ...
            <ol class="flex flex-col gap-0 px-4 py-3">
              ...
              <li class="flex items-start gap-3">
                ...
                <div class="min-w-0 flex-1 pb-4">
                  ...
                  <p class="text-xs text-muted-foreground">
                    <span v-if="props.approval.reviewed_by_name">{{
                    ...
                    <span v-if="props.approval.reviewed_at">{{
                      dateFormatter.format(new Date(props.approval.reviewed_at))
                    }}</span>
                  </p>
                  <p
                  ...
                  >
                    ...
                    <span class="font-medium">{{
                      dateFormatter.format(new Date(props.approval.expires_at))
                    }}</span>
                  </p>
                </div>
              </li>
              ...
              >
                ...
                <div class="min-w-0 flex-1">
                  ...
                  <p class="text-xs text-muted-foreground">
                    <span v-if="props.approval.consumed_by_name">{{
                    ...
                    <span v-if="props.approval.consumed_at">{{
                      dateFormatter.format(new Date(props.approval.consumed_at))
                    }}</span>
                  </p>
                </div>
              </li>
              ...
              >
                ...
                >
                  <KeyRound class="size-3 text-amber-600 dark:text-amber-400" />
                </div>
                <div class="min-w-0 flex-1">
                  <p
          ...
          <div v-if="props.approval.mode === 'draft'" class="space-y-2">
            <div
            ...
            <Alert
              v-if="!props.approval.subject_revision_matches_subject"
          ...
          <div v-if="props.approval.request_note" class="space-y-1.5">
            <div class="flex items-baseline gap-1.5">
              <p class="px-0.5 text-sm font-semibold text-foreground">
          ...
          >
            ...
            <CollapsibleContent>
              <pre
                ...
                >{{ formatJson(props.approval.subject_snapshot!) }}</pre
              >
            </CollapsibleContent>
          </Collapsible>
          ...
          >
            <Separator />
            <template
              v-if="props.approval.can_approve || props.approval.can_reject"
            >
              <Label for="cumpu-approval-show-review-note" class="text-sm">
                {{ __("Review note") }}
            ...
            <div class="flex flex-wrap gap-2 pt-1">
              <Button
                ...
                @click="submitApprove"
              >
                <Spinner v-if="isSubmitting" class="mr-1.5 size-4" />
                {{ isSubmitting ? __("Saving…") : __("Approve & issue grant") }}
              </Button>
              <Button
        ...
        <div class="space-y-5">
          ...
          <div
            v-if="props.approval.can_reassign && props.reassignOptions?.length"
          ...
          >
            <div class="flex items-center justify-between gap-3">
              <div class="space-y-0.5">
                ...
                <p class="text-xs text-muted-foreground">
                  {{ __("Redirect pending steps to different reviewers.") }}
                </p>
              </div>
              <Button
                size="sm"
