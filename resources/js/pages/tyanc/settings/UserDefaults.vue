      ...
      <form class="space-y-6" @submit.prevent="handleSubmit">
        ...
        <div class="space-y-4">
          <Heading
            ...
            :description="
              __('Starting values applied when new user accounts are created')
            "
          />
        ...
        <div class="space-y-4">
          <Heading
            ...
            :title="__('Appearance')"
            :description="
              __('Starting theme preference for newly created user accounts')
            "
          />

          <div class="grid max-w-xs gap-2">
            <Label for="appearance">{{ __("Default theme") }}</Label>
            <Select v-model="selectedAppearance">
              <SelectTrigger id="appearance" class="w-full">
                <SelectValue :placeholder="__('Select theme')" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem
