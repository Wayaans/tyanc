...
<template>
    ...
    >
        <DataTableToolbar
            ...
            :active-filters="tableQuery.appliedFilters.value"
            :draft-filters="tableQuery.draftFilters.value"
            :active-filter-count="tableQuery.activeFilterCount.value"
            :selected-row-count="tableQuery.selectedRowCount.value"
